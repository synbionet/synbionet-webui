      ...
      <form className="flex flex-col space-y-8" onSubmit={handleSubmit}>
        <label>
          ...
          <div className="w-full bg-white bg-opacity-10 rounded-md flex items-center">
            <input
              className="px-2 grow placeholder:italic placeholder:text-slate-200 bg-transparent py-2 pr-3 focus:outline-none sm:text-sm"
              type="text"
              value={titleValue}
        ...
        <label>
          ...
          <div className="w-full bg-white bg-opacity-10 rounded-md flex items-center">
            <textarea
              className="h-40 px-2 grow placeholder:italic placeholder:text-slate-200 bg-transparent py-2 pr-3 focus:outline-none sm:text-sm"
              type="text"
