  ...
  return (
    <div className="flex flex-1 pt-16">
      <div className="flex-1 flex flex-col items-center">
        <div className="h-[600px] shadow-lg rounded-full overflow-hidden">
        ...
        <div className="flex space-x-8 mt-20">
          <Link to="/network">
            <PrimaryButton disableElevation defaultSize text="network" />
          </Link>
          <Link to="/portfolio">
            <PrimaryButton disableElevation defaultSize text="portfolio" />
          </Link>
          <a target="_blank" href="https://github.com/synbionet" rel="noreferrer">
            <PrimaryButton defaultSize alternate text="GitHub" startIcon={<GitHubIcon />} />
          </a>
        </div>
      </div>
    </div>
